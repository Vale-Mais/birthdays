...
class TestName(unittest.TestCase):
    ...
    def test_return_birthday(self):
        result1 = print('{}\'s birthday is {}.'.format(self.correct_p, self.db["Birthday"].loc[self.db["Person"].str.lower()==self.correct_p.lower()].values[0]))
        self.assertEqual(c.return_birthday(self.correct_p),result1)
        result2 = print('Sadly, we don\'t have {}\'s birthday.'.format(self.new_p))
    ...
    def test_add_person(self):
        res1 = print("sorry, but " + self.correct_p + " is already present in the database, thank you anyway")
